...
var Home2 = React.createClass({
	...
	render: function () {
		...
		var x = this.state.data.map(function (d) {
			return React.createElement(Tuan, { colapse: d.colapse, active: d.active, key: d.tuan, tuan: d.tuan, data: d.data });
		});
...
var Tuan = React.createClass({
	...
	render: function () {
		var x = this.props.data.map(function (d) {
			return React.createElement(TuanRow, { key: 'tuanrow' + d.id, data: d });
		});
		return React.createElement(
			"div",
...
var TuanRow = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			"tr",
			{ style: boldstyle, "class": this.props.data.color },
			React.createElement(
				"td",
				null,
				this.props.data.thu
			...
			React.createElement(
				"td",
				null,
				this.props.data.thuc_hanh === false ? 'Lý thuyết' : 'Thực hành'
			),
			React.createElement(
				"td",
				null,
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				"td",
				null,
				this.props.data.updated === false ? 'Chưa kết thúc' : 'Đã hoàn thành'
			)
		);
	}
});
