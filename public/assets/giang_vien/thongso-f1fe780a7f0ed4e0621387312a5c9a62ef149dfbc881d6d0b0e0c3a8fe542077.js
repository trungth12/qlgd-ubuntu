	...
	handleSubmit: function () {
		...
		$.ajax({
			...
			success: (function (data2) {
				...
				React.renderComponent(React.createElement(Lop, { data: data2 }), document.getElementById('main'));
			}).bind(this)
		});
		return false;
	},
	componentWillMount: function () {
		$.ajax({
			...
			success: (function (data) {
				...
				React.renderComponent(React.createElement(Lop, { data: data }), document.getElementById('main'));
			}).bind(this)
		});
	},
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"td",
									null,
									React.createElement("div", { id: "ltdk", ref: "ltdk", style: { "width": "80%" } })
								)
							),
							React.createElement(
								"tr",
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"p",
									null,
									React.createElement("span", { dangerouslySetInnerHTML: { __html: this.state.data.lich_trinh_du_kien } })
								)
							)
						),
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									"p",
									null,
									React.createElement("span", { dangerouslySetInnerHTML: { __html: this.state.data.de_cuong_chi_tiet } })
								)
							)
						)
					)
